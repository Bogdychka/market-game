...
> **Historical snapshot:** this audit is not the live source of project truth. Several findings
> below have already been fixed or intentionally superseded; use `CHANGELOG.md [Unreleased]`,
> `dev_plan_4_1.md` progress, current serialized assets, and Unity MCP health for current status.
