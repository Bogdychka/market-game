    ...
    public class GetGameObjectResource : McpResourceBase
    {
        ...
        public override JObject Fetch(JObject parameters)
        {
            ...
            if (int.TryParse(idOrName, out int instanceId))
            {
                ...
                UnityEngine.Object unityObject = McpUnity.Utils.ObjectIdUtils.ObjectFromLegacyInstanceId(instanceId);
            ...
            return new JObject
            {
                ...
                ["instanceId"] = McpUnity.Utils.ObjectIdUtils.GetLegacyInstanceId(gameObject)
            };
        }
