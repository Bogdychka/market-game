...
namespace OceanSystem
{
    ...
    public class OceanSimulationInputsProvider : ScriptableObject
    {
        ...
        [Tooltip("Used in Fixed mode only.")]
        [SerializeField] private LocalWavesPreset _localWaves;

        [Header("Local Waves (Scale mode)")]
        [Tooltip("Wind force used for inspector previews. In play mode the value comes from OceanSimulation.")]
